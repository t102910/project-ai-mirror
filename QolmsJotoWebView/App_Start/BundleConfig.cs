...
namespace MGF.QOLMS.QolmsJotoWebView
{
    ...
    public class BundleConfig
    {
        ...
        private static void BundleStyles(BundleCollection bundles)
        {
            ...
            // premium 系ページ用 CSS
            bundles.Add(
                new StyleBundle("~/dist/css/premium")
                {
                    Orderer = new NonOrderingBundleOrderer()
                }.Include(
                    new string[]
            ...
            // Error 系ページ用 CSS
            bundles.Add(
                new StyleBundle("~/dist/css/error")
                {
                    Orderer = new NonOrderingBundleOrderer()
                }.Include(
                    new string[]
        ...
        private static void BundleScriptsOfStart(BundleCollection bundles)
        {
            ...
            // /start/loginbyid ページ用 Script（結合のみ）
            bundles.Add(
                new Bundle("~/dist/js/start/loginbyid", new NoJsTransform()) { Orderer = new NonOrderingBundleOrderer() }.Include(
                    "~/dist/js/jquery-3.7.1.min.js",
                    "~/dist/js/bootstrap.bundle.js",
                    "~/dist/js/slick.min.js",
                    "~/dist/js/spc.lib.min.js",
            ...
            // /start/error ページ用 Script（結合のみ）
            bundles.Add(
                new Bundle("~/dist/js/start/error", new NoJsTransform()) { Orderer = new NonOrderingBundleOrderer() }.Include(
                    "~/dist/js/jquery-3.7.1.min.js",
                    "~/dist/js/bootstrap.bundle.js",
                    "~/dist/js/slick.min.js",
                    "~/dist/js/spc.lib.min.js",
        ...
        private static void BundleScriptsOfPoint(BundleCollection bundles)
        {
            ...
            // /point/error ページ用 Script（結合のみ）
            bundles.Add(
                new Bundle("~/dist/js/point/error", new NoJsTransform()) { Orderer = new NonOrderingBundleOrderer() }.Include(
                    "~/dist/js/jquery-3.7.1.min.js",
                    "~/dist/js/bootstrap.bundle.js",
                    "~/dist/js/slick.min.js",
                    "~/dist/js/spc.lib.min.js",
        ...
        private static void BundleScriptsOfNote(BundleCollection bundles)
        {
            ...
            // /note/error ページ用 Script（結合のみ）
            bundles.Add(
                new Bundle("~/dist/js/note/error", new NoJsTransform()) { Orderer = new NonOrderingBundleOrderer() }.Include(
                    "~/dist/js/jquery-3.7.1.min.js",
                    "~/dist/js/bootstrap.bundle.js",
                    "~/dist/js/slick.min.js",
                    "~/dist/js/spc.lib.min.js",
        ...
        private static void BundleScriptsOfHealth(BundleCollection bundles)
        {
            ...
            // /health/error ページ用 Script（結合のみ）
            bundles.Add(
                new Bundle("~/dist/js/health/error", new NoJsTransform()) { Orderer = new NonOrderingBundleOrderer() }.Include(
                    "~/dist/js/jquery-3.7.1.min.js",
                    "~/dist/js/bootstrap.bundle.js",
                    "~/dist/js/slick.min.js",
                    "~/dist/js/spc.lib.min.js",
        ...
        private static void BundleScriptsOfPortal(BundleCollection bundles)
        {
            ...
            //portal/error ページ用 Script（結合のみ）
            bundles.Add(
                new Bundle("~/dist/js/portal/error", new NoJsTransform()) { Orderer = new NonOrderingBundleOrderer() }.Include(
                    "~/dist/js/jquery-3.7.1.min.js",
                    "~/dist/js/bootstrap.bundle.js",
                    "~/dist/js/slick.min.js",
                    "~/dist/js/spc.lib.min.js",
        ...
        /// <summary>
        /// premium 画面用 スクリプト を オプティマイズ するための、
        /// バンドル オブジェクト の セット を設定します。
        /// ※ JsMinify を一切通さない（結合のみ）
        /// </summary>
        /// <param name="bundles">バンドル オブジェクト の セット の コレクション。</param>
        private static void BundleScriptsOfPremium(BundleCollection bundles)
        {
            // /premium/error ページ用 Script（結合のみ）
            bundles.Add(
                new Bundle("~/dist/js/premium/error", new NoJsTransform()) { Orderer = new NonOrderingBundleOrderer() }.Include(
                    "~/dist/js/jquery-3.7.1.min.js",
                    "~/dist/js/bootstrap.bundle.js",
                    "~/dist/js/slick.min.js",
                    "~/dist/js/spc.lib.min.js",
        ...
        private static void BundleScriptsOfIntegration(BundleCollection bundles)
        {
            ...
            //integration/error ページ用 Script（結合のみ）
            bundles.Add(
                new Bundle("~/dist/js/integration/error", new NoJsTransform()) { Orderer = new NonOrderingBundleOrderer() }.Include(
                    "~/dist/js/jquery-3.7.1.min.js",
                    "~/dist/js/bootstrap.bundle.js",
                    "~/dist/js/slick.min.js",
                    "~/dist/js/spc.lib.min.js",
