...
namespace MGF.QOLMS.QolmsJotoWebView
{
    ...
    internal sealed class QjApiAuthorizeAttribute : AuthorizationFilterAttribute
    {
        #region "Constructor"
        public QjApiAuthorizeAttribute() : base() { }
        ...
        /// <summary>
        /// 値を指定して、
        /// <see cref="QjApiAuthorizeAttribute" />クラスの新しいインスタンスを初期化します。
        /// </summary>
        ...
        /// </param>
        /// <remarks></remarks>
        public QjApiAuthorizeAttribute(QjApiAuthorizeTypeEnum authType) : base()
        {
        ...
        private QjApiAuthorizeTypeEnum ExtractAuthorizationType(string authorizationHeader, QjApiAuthorizeTypeEnum authType)
        {
            ...
            else
            {
                ...
                if (verifiedAuthorizationHeader.IndexOf(QjApiAuthorizeAttribute.HTTP_BASIC_SCHEME_NAME) >= 0)
                {
                ...
                else if (verifiedAuthorizationHeader.IndexOf(QjApiAuthorizeAttribute.HTTP_BEARER_SCHEME_NAME) >= 0)
                {
