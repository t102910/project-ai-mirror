	...
	var drawGraph_bp = function ($g, dataName) {
		...
		case 'bloodPressure':
			...
			paramsW.tooltip = {
				...
				dateTimeLabelFormats: tpLabelFormats,
				formatter:function(){
		            return '<small style="font-size: 10px">' + Highcharts.dateFormat('%Y年%b%e日(%a)', new Date(this.x)) + '</small><br>' + '<tspan style="fill:' + this.series.color + '">血圧</tspan><tspan dx="0">: </tspan>' + '<b>' + this.point.high + '</b>' + ' / ' + '<b>' + this.point.low + 'mmHg</b>';
		        }
			};
			...
			paramsW.subtitle = {
				...
				text: '<div id="chartBPNote"><span class="bpUU">■【上】目標</span><br><span class="bpUL">■【下】目標</span></div>'
			};
	...
	var drawGraph_w = function ($g, dataName) {
		...
		case 'bodyWeight':
			...
			paramsW.yAxis[1].plotLines = [{
				width:2, color:'rgba(148,204,74,1)',
				dashStyle: 'solid',
				value: data.targetValues[2]
			},
			{
			...
			paramsW.subtitle = {
				...
				text: '<div id="chartBPNote"><span class="bpUL">■【体重】目標</span><br><span class="bpUL" style="color:#94cc4a!important;">■【BMI】目標</span></div>'
			};
			chartSeries.push({
				name: data.dataTitle[0],
				pointStart: Date.UTC(yy, mm, dd),
	...
	var drawGraph_bgl = function ($g, dataName) {
		...
		case 'bloodGlucoseLevel':
			...
			paramsW.subtitle = {
				...
				useHTML: true,
				//text: '<div id="chartBPNote"><span class="bpUU">&mdash;&middot;&mdash;【通常時】目標上限</span>　　<span class="bpUL">&mdash;&middot;&mdash;【通常時】目標下限</span></div><br><div id="chartBPNote"><span class="bpLU">&ndash;&ndash;&ndash;【空腹時】目標上限</span>　 　<span class="bpLL">&ndash;&ndash;&ndash;【空腹時】目標下限</span></div>'
				text: '<div id="chartBPNote"><span class="bpUU">■【その他】目標</span><br><span class="bpUL">■【空腹時】目標</span></div>'
			};
			chartSeries.push({
				name: data.dataTitle[0],
				pointStart: Date.UTC(yy, mm, dd),
