// mgf.integration.omronconnection 名前空間オブジェクト
mgf.integration = mgf.integration || {};
mgf.integration.omronconnection = mgf.integration.omronconnection || {};

mgf.integration.omronconnection = (function () {
    function moveToMockState(context, isConnected) {
        var fromPageNo = $("section.home-btn-wrap").data("pageno");
        var url = "../Integration/omronConnection?mockConnected=" + (isConnected ? "true" : "false");
