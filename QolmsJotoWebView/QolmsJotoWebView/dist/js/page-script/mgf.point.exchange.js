// mgf.point.exchange 名前空間オブジェクト
mgf.point.exchange = mgf.point.exchange || {};

// DOM 構築完了
mgf.point.exchange = (function () {
    // ヒストリー バック禁止
    ...
    //確認モーダル「交換する」
    $("main").on("click", "#confirmation-modal div.modal-footer a.btn-submit", function () {
