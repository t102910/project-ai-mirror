...
namespace MGF.QOLMS.QolmsOpenApi.AzureStorage
{
    ...
    internal sealed class AccessTableEntityWriter<TTableEntity>
        ...
        IQsAzureTableStorageWriter<TTableEntity, AccessTableEntityWriterArgs<TTableEntity>, AccessTableEntityWriterResults>
        where TTableEntity : QsAccessTableEntityBase, new()
    {
        #region "Constructor"

        /// <summary>
        /// <see cref="AccessTableEntityWriter&lt;TTableEntity&gt;" /> クラス の新しい インスタンス を初期化します。
        /// </summary>
