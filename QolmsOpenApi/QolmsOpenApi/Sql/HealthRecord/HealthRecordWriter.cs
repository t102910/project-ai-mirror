...
namespace MGF.QOLMS.QolmsOpenApi.Sql
{
    ...
    /// </summary>
    public class HealthRecordWriter : QsDbWriterBase, IQsDbDistributedWriter<MGF_NULL_ENTITY, HealthRecordWriterArgs, HealthRecordWriterResults>
    {
        /// <summary>
        ...
        public HealthRecordWriterResults ExecuteByDistributed(HealthRecordWriterArgs args)
        {
            var actionDate = DateTime.Now;
            var actionKey = Guid.NewGuid();

            var result = new HealthRecordWriterResults
            {
                IsSuccess = false,
            ...
            Guid actionKey)
        {
            ...
            foreach (var item in vitalValueN)
            {
                ...
                var logEntity = new QH_HEALTHRECORDHIST_LOG
                {
                    ...
                    ACTIONDATE = actionDate,
                    ACTIONKEY = actionKey,
                    HISTTYPE = (byte)QH_HEALTHRECORDHIST_LOG.HistTypeEnum.Added,
