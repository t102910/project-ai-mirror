...
''' <summary>
''' 「お薬手帳」画面表示用、調剤薬、市販薬ノートを表します。
''' このクラスは継承できません。
''' </summary>
''' <remarks></remarks>
<Serializable()>
Public NotInheritable Class MedicineItem
...
#Region "Public Property"
    ...
    ''' <summary>
    ''' 詳細情報（お薬情報）を取得または設定します。
    ''' </summary>
    ''' <value></value>
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Property NonPrescriptionSet As QhMedicineSetOtcDrugOfJson = Nothing
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Property AttachedFileN As New List(Of List(Of AttachedFileItem))
...
#Region "Constructor"
    ...
    ''' <summary>
    ''' <see cref="MedicineItem" />クラスの新しいインスタンスを初期化します。
    ''' </summary>
    ''' <remarks></remarks>
    Public Sub New()
    End Sub
