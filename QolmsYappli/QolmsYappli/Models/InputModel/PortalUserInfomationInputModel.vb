...
<Serializable()>
Public NotInheritable Class PortalUserInfomationInputModel
...
#Region "Public Property"
    ...
    ''' <remarks></remarks>
    <DisplayName("都道府県")>
    Public Property Prefectures As Integer = Integer.MinValue
...
#Region "Constructor"
    ...
    ''' <summary>
    ''' <see cref="PortalUserInfomationInputModel" /> クラスの新しいインスタンスを初期化します。
    ''' </summary>
    ''' <remarks></remarks>
    Public Sub New()
        MyBase.New()
...
#Region "Public Method"
    ...
    ' ''' <remarks></remarks>
    'Public Sub UpdateByInput(inputModel As PortalUserInfomationInputModel) Implements IQyModelUpdater(Of PortalUserInfomationInputModel).UpdateByInput
