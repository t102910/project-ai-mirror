...
<Serializable()>
Public NotInheritable Class StartSetupInputModel
    Inherits QyPageViewModelBase
    Implements IQyModelUpdater(Of StartSetupInputModel), 
    IValidatableObject
...
#Region "Constructor"
    ...
    ''' <summary>
    ''' <see cref="StartSetupInputModel" /> クラスの新しいインスタンスを初期化します。
    ''' </summary>
    ''' <remarks></remarks>
    Public Sub New()
...
#Region "Private Method"
    ...
    Private Function CalcBasalMetabolism(weight As Decimal) As Decimal
        ...
        If weight > Decimal.Zero AndAlso day <> Date.MinValue Then
            ...
            If age > 0 Then
                Dim data As Tuple(Of QySexTypeEnum, Integer, Integer, Decimal) = StartSetupInputModel.calcData1.Find(
                    Function(i)
    ...
    '        If age > 0 Then
    '            Dim data As Tuple(Of Byte, Integer, Integer, Decimal) = StartSetupInputModel.calcData2.Find(
    '                Function(i)
    ...
    ''' </returns>
    ''' <remarks></remarks>
    Private Function CheckDecimalValue(value As String, Optional lowerLimit As Decimal = StartSetupInputModel.MIN_VALUE, Optional upperLimit As Decimal = StartSetupInputModel.MAX_VALUE) As Decimal
            ...
            Case Else
                ...
                Return New List(Of String)() From {
                    Me.CreateErrorMessage(
                        StartSetupInputModel.REQUIRED_ERROR_MESSAGE,
                        String.Empty,
                        name
                    )
                }
    ...
    Private Function CheckHeightValue() As List(Of String)
        ...
        Dim lower As Decimal = StartSetupInputModel.valueRanges(valueType).Item1
        Dim upper As Decimal = StartSetupInputModel.valueRanges(valueType).Item2
        Dim scale As Integer = StartSetupInputModel.valueRanges(valueType).Item3
        ...
        If decimalValue = Decimal.MinValue Then
            ...
            result.Add(
                Me.CreateErrorMessage(
                    StartSetupInputModel.RANGE_ERROR_MESSAGE,
                    String.Empty,
                    name,
                    lower,
                    upper
        ...
        ElseIf Not Me.CheckDecimalPartScale(
            ...
            result.Add(
                Me.CreateErrorMessage(
                    StartSetupInputModel.DECIMAL_PART_DIGIT_ERROR_MESSAGE,
                    String.Empty,
                    name,
                    scale
                )
    ...
    Private Function CheckCaloriesInValue() As List(Of String)
        ...
        ElseIf Not Me.CheckDecimalPartScale(
            ...
            result.Add(
                Me.CreateErrorMessage(
                    StartSetupInputModel.DECIMAL_PART_ERROR_MESSAGE,
                    String.Empty,
                    name,
                    scale
                )
...
#Region "Public Method"
    ...
    Public Sub UpdateByInput(inputModel As StartSetupInputModel) Implements IQyModelUpdater(Of StartSetupInputModel).UpdateByInput
