...
''' <remarks></remarks>
<Serializable()>
Public NotInheritable Class NoteHeartRateViewModel
...
#Region "Variable"
    ...
    ''' <summary>
    ''' ビューに展開する通知のリストを保持します。
    ''' </summary>
    ''' <remarks></remarks>
    Protected _noticeList As List(Of String) = New List(Of String)
...
#Region "Public Property"
    ...
    ''' <summary>
    ''' ビューに展開する通知のリストを取得します。
    ''' </summary>
    ''' <value></value>
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public ReadOnly Property NoticeList As List(Of String)

        Get
            Return Me._noticeList
        End Get
    ...
    ''' <summary>
    ''' アラートを表示するかどうかを取得または設定します。
    ''' </summary>
    ''' <value></value>
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Property IsDispAlert As Boolean = False
...
#Region "Constructor"
    ...
    ''' <summary>
    ''' <see cref="NoteHeartRateViewModel" /> クラスの新しいインスタンスを初期化します。
    ''' </summary>
    ''' <remarks></remarks>
    Public Sub New()
    ...
    Public Sub New(mainModel As QolmsYappliModel)
        ...
        MyBase.New(mainModel, QyPageNoTypeEnum.NoteHeartRate)
    ...
    Public Sub New(mainModel As QolmsYappliModel,
                   ...
                   endDate As DateTime,
                   noticeList As List(Of String),
                   isDispAlert As Boolean)
        ...
        ' 通知を表示するかどうか
        Me.IsDispAlert = isDispAlert

        ' 通知
        Me._noticeList = noticeList
...
#Region "Protected Method"
    ...
    ''' <summary>
    ''' <see cref="NoteHeartRateViewModel" /> クラスのインスタンスを初期化します。
    ''' </summary>
    ...
    Protected Sub InitializeBy(items As IEnumerable(Of VitalValueItem))
        ...
        If Me.PeriodType = QyPeriodTypeEnum.OneDay Then
            ...
            While targetDate < tomorrowDate
                ...
                targetDate = targetDate.AddMinutes(5)
        ...
        For Each item As VitalValueItem In items
            ...
            If Me.PeriodType = QyPeriodTypeEnum.OneDay Then
                ...
                key = New Date(item.RecordDate.Year,
                               ...
                               Convert.ToInt32(Math.Floor(item.RecordDate.Minute / 5.0) * 5.0),
                               0)
        ...
        For a As Integer = 0 To Me._itemList.Count - 1
            ...
            If values.Count > 0 Then
                ...
                If count > 0 Then
                    ...
                    average = Decimal.Round(average / count, MidpointRounding.AwayFromZero)
    ...
    Protected Function CreateGraphData() As String
        ...
        For Each kv As KeyValuePair(Of Date, SortedDictionary(Of Date, VitalValueItem)) In Me._itemList
            ' 0 以下のデータが存在するのでその場合は null 表示(中抜け)
