...
''' <remarks></remarks>
<Serializable()>
Public NotInheritable Class PortalAmazonGiftCardViewModel
...
#Region "Public Property"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Property GiftCardN As New List(Of AmazonGiftCardItem)()
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Property GiftCardHistN As New List(Of AmazonGiftCardHistItem)()
...
#Region "Constructor"
    ...
    ''' <summary>
    ''' <see cref="PortalAmazonGiftCardViewModel" /> クラスの新しいインスタンスを初期化します。
    ''' </summary>
    ''' <remarks></remarks>
    Public Sub New()
