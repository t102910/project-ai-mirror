...
@ModelType HealthAgeGlucoseReportPartialViewModel
    ...
    @<article id="glucose-area" class="reload-area" data-report-type="@QyHealthAgeReportTypeEnum.Glucose.ToString()">
        ...
        <section class="inner reload-area"> <!-- AJAX-非同期更新エリア load中は.loadingを付与してください。gifアニメーションと文言出ます。-->
            ...
            <script type="text/javascript">
                ...
                var hrChartData_a1c = {
                    data: {
                        title: @Html.Raw(Me.Model.Ch035GraphSetting.Title),
                        max: @Html.Raw(Me.Model.Ch035GraphSetting.AxisMax),
                        min: @Html.Raw(Me.Model.Ch035GraphSetting.AxisMin),
                        dayLabel: @Html.Raw(Me.Model.Ch035GraphSetting.Label),
                        targetValues: @Html.Raw(Me.Model.Ch035GraphSetting.TargetValue), // [0]正常値min [1]正常値max / [2]注意値min [3]注意値max / [4]注意値min [5]注意値max / [6]警告値min [7]警告値max / [8]警告値min [9]警告値max
                        data: @Html.Raw(Me.Model.Ch035GraphSetting.Data)
                        }
                };
            </script>
            ...
            <script type="text/javascript">
                ...
                var hrChartData_bgl = {
                    data: {
                        title: @Html.Raw(Me.Model.Ch035FbgGraphSetting.Title),
                        max: @Html.Raw(Me.Model.Ch035FbgGraphSetting.AxisMax),
                        min: @Html.Raw(Me.Model.Ch035FbgGraphSetting.AxisMin),
                        dayLabel: @Html.Raw(Me.Model.Ch035FbgGraphSetting.Label),
                        targetValues: @Html.Raw(Me.Model.Ch035FbgGraphSetting.TargetValue), // [0]正常値min [1]正常値max / [2]注意値min [3]注意値max / [4]注意値min [5]注意値max / [6]警告値min [7]警告値max / [8]警告値min [9]警告値max
                        data: @Html.Raw(Me.Model.Ch035FbgGraphSetting.Data)
                    }
                };
            </script>
