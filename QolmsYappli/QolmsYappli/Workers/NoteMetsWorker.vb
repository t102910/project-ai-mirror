...
Friend NotInheritable Class NoteMetsWorker
...
#Region "Public Method"
    ...
    Public Shared Function CreateViewModel(mainModel As QolmsYappliModel, periodType As QyPeriodTypeEnum, startDate As DateTime, endDate As DateTime) As NoteMetsViewModel

        Dim viewModel As NoteMetsViewModel = Nothing

        ' 基準値は固定値になったのでコメントアウトしておきます
        'With NoteMetsWorker.ExecuteNoteVitalReadApi(mainModel)
        '    ' バイタル標準値
        ...
        NoteMetsWorker.GetTargetValues(mainModel, QyVitalTypeEnum.Mets, targetValues(0), targetValues(1), targetValues(2), targetValues(3))

        With NoteMetsWorker.ExecuteNoteVitalDetailReadApi(mainModel, startDate, endDate, QyVitalTypeEnum.Mets)

            viewModel = New NoteMetsViewModel(mainModel,
