//  名前空間オブジェクト
mgf.passwordreset.recover = mgf.passwordreset.recover || {};

mgf.passwordreset.recover = (function () {

    var successView = function () {

        $.ajax({
            type: "POST",
            url: "../passwordreset/RecoverResult?ActionSource=Success",
            data: {
    ...
    $("main").on("click", "#request", function () {
        ...
        $.ajax({
            type: "POST", 
            url: "../passwordreset/recoverResult?ActionSource=Send",
            data: {
                __editVerificationToken: $("input[name='__RequestVerificationToken']").val(),
                MailAddress: mail
            },
