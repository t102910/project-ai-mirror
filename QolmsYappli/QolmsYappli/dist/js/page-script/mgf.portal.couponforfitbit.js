// mgf.portal.pointexchange 名前空間オブジェクト
mgf.portal.pointexchange = mgf.portal.pointexchange || {};

// DOM 構築完了
mgf.portal.pointexchange = (function () {
    // ヒストリー バック禁止
    ...
    $("main").on("click", "#confirmation-modal .btn-submit", function () {
        ...
        $.ajax({
            type: "POST",
            url: "../Portal/CouponForFitbitResult",
            data: {
            ...
            try {
                ...
                if (jqXHR.status == 200 && jqXHR.getResponseHeader("Content-Type").indexOf("application/json;") >= 0 && $.isTrueString($.parseJSON(data)["IsSuccess"])) {
                    ...
                    location.href = "../Portal/CouponForFitbit" + $("#back").data("back");
