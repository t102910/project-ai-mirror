//  名前空間オブジェクト
mgf.portal.smsauthentication = mgf.portal.smsauthentication || {};

mgf.portal.smsauthentication = (function () {
    ...
    var successView = function (phone) {
        ...
        $.ajax({
            type: "POST",
            url: "../portal/SMSAuthenticationResult?ActionSource=Success",
            data: {
    ...
    $("main").on("click", "#request", function () {
        ...
        $.ajax({
            type: "POST", 
            url: "../portal/SMSAuthenticationResult?ActionSource=Send",
            data: {
                __editVerificationToken: $("input[name='__RequestVerificationToken']").val(),
                PhoneNumber: phone
            },
    ...
    $("main").on("click", "#passcode", function () {
        ...
        $.ajax({
            type: "POST",
            url: "../portal/SMSAuthenticationResult?ActionSource=PassCode",
            data: {
                __editVerificationToken: $("input[name='__RequestVerificationToken']").val(),
                PhoneNumber: phone,
                PassCode: pass
