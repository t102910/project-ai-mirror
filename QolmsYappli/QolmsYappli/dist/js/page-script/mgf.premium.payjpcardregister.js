...
mgf.premium.payjpcardregister = (function () {
    ...
    $("main").on("click", "#Register", function () {
        ...
        $.ajax({
            type: "POST",
            url: "../Premium/PayJpCardRegisterResult?ActionSource=tds",
            data: {
            ...
            try {
                ...
                if (jqXHR.status == 200 && jqXHR.getResponseHeader("Content-Type").indexOf("application/json;") >= 0 && $.isTrueString($.parseJSON(data)["IsSuccess"])) {
                    ...
                    location.href ='../Premium/PayJpCardRegisterTokenRedirect'
    ...
    //    $.ajax({
    //        type: "POST",
    //        url: "../Premium/PayJpCardRegisterResult?ActionSource=Reserve",
    //        data: {
    //            __RequestVerificationToken: $("input[name='__RequestVerificationToken']").val(),
    //        },
    //        async: true,
